...
class Page {
    ...
    // 分页的栏的总页数
    protected $coolPages   ;
    // 分页显示定制 ,'last'=>'末页' %end%<img src='__PUBLIC__/images/next.jpg'>
    ...
    public function show() {
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage   =   "<a href='".str_replace('__PAGE__',$nextRow,$url)."' >下5页</a>";    // 下5页 改成了 >> = 下5页
        ...
        $pageStr = str_replace(
            ...
            // html排版靠这个顺序
            array($this->config['header'], $this->nowPage, $this->totalRows, $this->totalPages, $theFirst, $prePage, $upPage, $linkPage, $downPage, $nextPage, $theEnd),
            $this->config['theme']
            );
        return $pageStr;
    }
