var EcommerceProductsEdit = function () {
    ...
    var handleImages = function() {
        ...
        var uploader = new plupload.Uploader({
            ...
            url : "http://1.s28waimai.sinaapp.com/index.php/Admin/Shop/Insert",    //需要自己写
            ...
            init: {
                ...
                //重点在这里，上传的时候自定义参数信息
                    uploader.setOption("multipart_params",{
                        "name":document.getElementById('name').value,"price":document.getElementById('price').value,"cate":document.getElementById('category').value
                    });
                },
